...
class LoginPagina extends StatefulWidget {
  ...
  autenticarUsuario(BuildContext context, Login login) {
     StoreProvider.of<AppEstado>(context).dispatch( autenticarUsuarioAccion);
  }
        ...
        Container(
          ...
          child: Column(
            children: <Widget>[
              ...
              Text('Seguro Inteligente', style: TextStyle( color: Colors.white, fontSize: 25.0 ))
            ],
          ),
        )
...
_crearCampos(BuildContext context,Login login) {
  return Column(
              children: <Widget>[
 ...
 Widget _crearEmail(Login login) {
    return Container(
        ...
        child: TextField(
          ...
          onChanged: (value){ login.usuario = value;} ,
        ),
      );
  }

Widget _crearPassword(Login login) {
 ...
 Widget _crearBoton( BuildContext context,Login login) {
